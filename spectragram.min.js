    ...
    //Search for a user by name.
      ...
      var self = this,
        ...
        for (var i = 0; i < max; i++) {
          ...
          self.$elem.append($(self.options.wrapEachWith).append("<a title='" + results.data[i].caption.text + "' target='_blank' class='lazy_loading' href='" + results.data[i].link + "'><img src='" + size + "'></img></a>"));
        }
            }
